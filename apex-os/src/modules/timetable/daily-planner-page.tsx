      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-[22px] font-extrabold tracking-tight md:text-3xl">Daily Planner</h1>
        ...
        <div className="flex items-center gap-3">
          <Input
            ...
            className="w-auto bg-surface-2 border-line text-white rounded-xl focus-visible:ring-indigo-500 font-medium"
          />
          <Button 
          ...
          <div className="text-center py-16 px-6 space-y-4">
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              <Button
                ...
                className="bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl gap-2 font-medium"
              >
              ...
              <Button
                variant="outline"
                onClick={() => setModalOpen(true)}
                className="border-line text-white hover:bg-white/10 rounded-xl"
              >
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <input
                          ...
                          className="bg-transparent border-b border-transparent hover:border-line-strong focus:border-indigo-500 outline-none text-zinc-200 text-xs w-full transition-colors py-1"
                        />
                      </td>

                      <td className="px-5 py-4">
                        <div className="flex items-center gap-1.5">
                          <Badge variant="outline" className="text-[11px] bg-white/5 border-line text-zinc-300">
                            {entry.category || 'General'}
                          </Badge>
                          <Badge variant="outline" className="text-[11px] bg-indigo-500/10 border-indigo-500/30 text-indigo-300">
                            {entry.priority || 'P1'}
                          </Badge>
                        </div>
                      </td>
          ...
          <form onSubmit={handleAddEntry} className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                className="bg-surface-2 border-line text-white rounded-xl focus-visible:ring-indigo-500"
              />
            </div>
