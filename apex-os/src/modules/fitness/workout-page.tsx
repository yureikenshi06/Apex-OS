  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto text-foreground font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-[22px] font-extrabold tracking-tight md:text-3xl">Trainer Workout Routine</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="p-3.5 rounded-2xl bg-surface-1 border border-line flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[11px] text-zinc-400 block">+2.5 kg once rep target hit for 2 sessions</span>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-surface-1 border border-line flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[11px] text-zinc-400 block">2–3 reps in reserve on compound lifts</span>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-surface-1 border border-line flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[11px] text-zinc-400 block">6 days training • Sleep 7.5+ hrs</span>
          </div>
        </div>
      </div>

      {/* Day Selector Tabs */}
      <div className="flex overflow-x-auto gap-2 p-1.5 bg-surface-2 rounded-2xl border border-line">
        {TRAINER_WORKOUT_PLAN.map((d, idx) => (
          ...
          >
            ...
            <span className="text-[11px] px-1.5 py-0.2 rounded bg-white/15 font-mono">
      ...
      <Card className="bg-surface-1 border border-line rounded-[20px] p-6 space-y-6">
        ...
        {currentPlanDay.exercises.length === 0 ? (
          <div className="text-center py-12 px-4 space-y-2 bg-surface-2/40 rounded-2xl border border-line/70">
                    ...
                    <div className="flex items-center gap-3.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge variant="outline" className="text-[11px] border-line text-zinc-400 bg-white/5">
                            {ex.muscle_group}
                          </Badge>
