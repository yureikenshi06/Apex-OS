  ...
  return (
    <div className="text-fg space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-[22px] font-extrabold tracking-tight md:text-3xl">Sleep & Recovery</h1>
        <button className="bg-primary text-white px-4 py-2 rounded-lg font-medium">Log Sleep</button>
      </div>
