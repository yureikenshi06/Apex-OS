...
export default function TasksPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto text-foreground space-y-6 font-sans">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-[22px] font-extrabold tracking-tight md:text-3xl">Task Command Center</h1>
        ...
        <Button 
          ...
          className="bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl gap-1.5 h-10 px-5 text-xs shrink-0"
        >
      ...
      <div className="bg-surface-1 border border-blue-500/25 rounded-[20px] p-5 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="space-y-2 flex-1 max-w-md">
            ...
            <div className="w-full bg-surface-2 rounded-full h-3 overflow-hidden border border-line/70 flex">
              <div 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 shrink-0">
            <div className="bg-surface-2 border border-line/70 p-2.5 rounded-2xl min-w-[100px]">
            ...
            <div className="bg-surface-2 border border-blue-500/20 p-2.5 rounded-2xl min-w-[100px]">
            ...
            <div className="bg-surface-2 border border-emerald-500/20 p-2.5 rounded-2xl min-w-[100px]">
            ...
            <div className="bg-surface-2 border border-rose-500/20 p-2.5 rounded-2xl min-w-[100px]">
      ...
      <div className="bg-surface-1 border border-line p-3.5 rounded-[20px] flex flex-col md:flex-row md:items-center justify-between gap-3">
        {/* Left: View Toggle & Status Tabs */}
        <div className="flex flex-wrap items-center gap-2">
          {/* List vs Board Toggle */}
          <div className="flex items-center p-1 bg-surface-2 rounded-2xl border border-line">
            <button
              onClick={() => setView('list')}
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                view === 'list' ? 'bg-blue-600 text-white' : 'text-zinc-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                view === 'kanban' ? 'bg-blue-600 text-white' : 'text-zinc-400 hover:text-white'
              }`}
            >
          ...
          {/* Status Filter Tabs */}
          <div className="hidden sm:flex items-center p-1 bg-surface-2 rounded-2xl border border-line">
            {[
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative flex-1 min-w-[140px] max-w-xs">
            ...
            <Input 
              ...
              className="pl-8 bg-surface-2 border-line text-white rounded-xl h-8 text-xs placeholder:text-zinc-500 w-full"
            />
          </div>

          {/* Category Dropdown */}
          <Select value={filterCategory} onValueChange={setFilterCategory}>
            <SelectTrigger className="w-[125px] bg-surface-2 border-line text-xs rounded-xl h-8 text-zinc-300">
          ...
          <Select value={filterPriority} onValueChange={setFilterPriority}>
            <SelectTrigger className="w-[115px] bg-surface-2 border-line text-xs rounded-xl h-8 text-zinc-300">
